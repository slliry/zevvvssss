          ...
          <div className="relative rounded-[2rem] bg-gradient-to-br from-[#004aad] to-[#0066cc] p-12 text-center text-white shadow-2xl md:p-16 lg:p-20">
            ...
            <div className="relative z-10">
              <h2 className="mb-6 text-4xl font-bold text-white md:text-5xl lg:text-6xl">
                <EditableTranslation translationKey="cta.title">{t('cta.title')}</EditableTranslation>
              </h2>
              <p className="mx-auto mb-10 max-w-2xl text-lg text-white/90 md:text-xl lg:text-2xl leading-relaxed">
                <EditableTranslation translationKey="cta.description">{t('cta.description')}</EditableTranslation>
              </p>
              <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                ...
                >
                  <EditableTranslation translationKey="cta.button">{t('cta.button')}</EditableTranslation>
