...
export default function RiskManagement() {
    ...
    return (
        <div className="bg-[#F7FFFE]">
            <SEO
                title={t('riskManagement.title') + ' - Zeus GRC'}
                description={t('riskManagement.heroDescription')}
                url="/modules/risk-management"
            />
            {/* Hero Section */}
            <section className="relative flex min-h-screen items-center overflow-hidden bg-[#F7FFFE] py-20 md:py-0">
                <div className="relative mx-auto grid max-w-[1440px] items-center gap-12 px-6 lg:grid-cols-2 lg:gap-16 lg:px-12">
                    ...
                    >
                        ...
                        >
                            ← <EditableTranslation translationKey="riskManagement.backToModules">{t('riskManagement.backToModules')}</EditableTranslation>
                        </Link>
                        <h1 className="mb-6 text-5xl font-bold text-[#1A1A1A] md:text-7xl">
                            <EditableTranslation translationKey="riskManagement.title">{t('riskManagement.title')}</EditableTranslation>
                        </h1>
                        ...
                        >
                            ...
                            >
                                <EditableTranslation translationKey="riskManagement.cta.button">{t('riskManagement.cta.button')}</EditableTranslation>
                                <ArrowRight size={20} />
                            </Link>
                        </motion.div>
                    </motion.div>
            ...
            <section className="mx-auto max-w-[1440px] px-6 py-20 lg:px-12 md:py-32">
                ...
                >
                    <h2 className="mb-4 text-4xl font-bold md:text-5xl">
                        <EditableTranslation translationKey="riskManagement.beforeAfter.title">{t('riskManagement.beforeAfter.title')}</EditableTranslation>
                    </h2>
                    <p className="mx-auto max-w-2xl text-xl text-gray-600">
                        <EditableTranslation translationKey="riskManagement.beforeAfter.subtitle">{t('riskManagement.beforeAfter.subtitle')}</EditableTranslation>
                    </p>
                </motion.div>
                    ...
                    >
                        <div className="mb-6 flex items-center gap-3">
                            ...
                            <h3 className="text-2xl font-bold text-red-900">
                                <EditableTranslation translationKey="riskManagement.beforeAfter.before">{t('riskManagement.beforeAfter.before')}</EditableTranslation>
                            </h3>
                        </div>
                    ...
                    >
                        <div className="mb-6 flex items-center gap-3">
                            ...
                            <h3 className="text-2xl font-bold text-white">
                                <EditableTranslation translationKey="riskManagement.beforeAfter.solution">{t('riskManagement.beforeAfter.solution')}</EditableTranslation>
                            </h3>
                        </div>
                        <ul className="space-y-3">
                    ...
                    >
                        <div className="mb-6 flex items-center gap-3">
                            ...
                            <h3 className="text-2xl font-bold text-green-900">
                                <EditableTranslation translationKey="riskManagement.beforeAfter.result">{t('riskManagement.beforeAfter.result')}</EditableTranslation>
                            </h3>
                        </div>
                        <ul className="space-y-3">
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            <h2 className="mb-4 text-3xl font-bold text-white md:text-5xl">
                                <EditableTranslation translationKey="riskManagement.cta.title">{t('riskManagement.cta.title')}</EditableTranslation>
                            </h2>
                            <p className="mb-8 text-lg text-white/90 md:text-xl">
                                <EditableTranslation translationKey="riskManagement.cta.description">{t('riskManagement.cta.description')}</EditableTranslation>
                            </p>
                            <Link
                                to="/request"
