...
export default function BusinessConsulting() {
    ...
    const valueItems = t('businessConsulting.value', { returnObjects: true }) || [];
    const offerItems = t('businessConsulting.offer', { returnObjects: true }) || [];

    return (
        <div className="bg-[#F7FFFE]">
            <SEO
                title={t('businessConsulting.title') + ' - Zeus GRC'}
                description={t('businessConsulting.subtitle')}
                ...
                <div className="relative mx-auto w-full max-w-[1392px] px-6 lg:px-16">
                    ...
                    >
                        ...
                        <div className="mt-10 flex flex-wrap gap-4">
                            ...
                            >
                                {t('businessConsulting.ctaMain')} <ArrowRight size={18} />
                            </Link>
                            <Link
                                to="/consulting"
            ...
            <section className="bg-white py-16">
                <div className="mx-auto max-w-[1392px] px-6 lg:px-16">
                    ...
                    >
                        <p>{t('businessConsulting.desc1')}</p>
                        <p>{t('businessConsulting.desc2')}</p>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="bg-[#F5FCFF] py-16">
                <div className="mx-auto max-w-[1392px] px-6 lg:px-16">
                    ...
                    >
                        ...
                        >
                            {t('businessConsulting.valueTitle')}
                        </h2>
                    </motion.div>
            ...
            <section className="bg-white py-16">
                <div className="mx-auto max-w-[1392px] px-6 lg:px-16">
                    ...
                    >
                        ...
                        >
                            {t('businessConsulting.offerTitle')}
                        </h2>
                    </motion.div>
                    <div className="grid grid-cols-1 gap-x-8 gap-y-4 md:grid-cols-2">
