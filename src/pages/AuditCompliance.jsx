...
export default function AuditCompliance() {
    ...
    const problems = [
        t('auditCompliance.problems.manual'),
        t('auditCompliance.problems.scattered'),
        t('auditCompliance.problems.noTracking'),
        t('auditCompliance.problems.timeConsuming'),
        t('auditCompliance.problems.noEvidence'),
        t('auditCompliance.problems.riskMissed'),
    ];

    const solutions = [
        t('auditCompliance.solutions.planning'),
        t('auditCompliance.solutions.checklists'),
        t('auditCompliance.solutions.capa'),
        t('auditCompliance.solutions.monitoring'),
        t('auditCompliance.solutions.integration'),
        t('auditCompliance.solutions.automation'),
    ];

    const results = [
        { icon: Zap, text: t('auditCompliance.results.efficiency') },
        { icon: Eye, text: t('auditCompliance.results.transparency') },
        { icon: Shield, text: t('auditCompliance.results.compliance') },
        { icon: Target, text: t('auditCompliance.results.quality') },
        { icon: Network, text: t('auditCompliance.results.centralized') },
        { icon: Sparkles, text: t('auditCompliance.results.standards') },
    ];

    return (
        <div className="bg-[#F7FFFE]">
            <SEO
                title={t('auditCompliance.title') + ' - Zeus GRC'}
                description={t('auditCompliance.heroDescription')}
