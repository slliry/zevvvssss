...
export default function TaskManagement() {
    ...
    const problems = [
        t('taskManagement.problems.scattered'),
        t('taskManagement.problems.noTracking'),
        t('taskManagement.problems.missedDeadlines'),
        t('taskManagement.problems.noAccountability'),
        t('taskManagement.problems.manualReminders'),
        t('taskManagement.problems.noIntegration'),
    ];

    const solutions = [
        t('taskManagement.solutions.creation'),
        t('taskManagement.solutions.assignment'),
        t('taskManagement.solutions.comments'),
        t('taskManagement.solutions.deadlines'),
        t('taskManagement.solutions.dashboard'),
        t('taskManagement.solutions.integration'),
    ];

    const results = [
        { icon: Target, text: t('taskManagement.results.centralized') },
        { icon: Shield, text: t('taskManagement.results.security') },
        { icon: Zap, text: t('taskManagement.results.risks') },
        { icon: Eye, text: t('taskManagement.results.compliance') },
        { icon: Network, text: t('taskManagement.results.transparency') },
        { icon: Sparkles, text: t('taskManagement.results.efficiency') },
    ];

    return (
        <div className="bg-[#F7FFFE]">
            <SEO
                title={t('taskManagement.title') + ' - Zeus GRC'}
                description={t('taskManagement.heroDescription')}
                url="/modules/task-management"
            />
            {/* Hero Section */}
