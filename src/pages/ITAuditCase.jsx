...
export default function ITAuditCase() {
    const { t } = useTranslation();

    const solutionItems = t('itAuditCase.solutionItems', { returnObjects: true }) || [];
    const resultsItems = t('itAuditCase.resultsItems', { returnObjects: true }) || [];

    return (
        <div className="bg-[#F7FFFE]">
            <SEO
                title={t('itAuditCase.title') + ' - Zeus GRC'}
                description={t('itAuditCase.subtitle')}
                url="/consulting/cases/it-audit"
            />
